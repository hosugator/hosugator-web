        ...
        <div className="overflow-hidden">
          ...
          <nav className="flex flex-col gap-10 text-sm font-bold tracking-[0.2em] uppercase">
            {['About', 'Experience', 'Projects', 'Insights', 'Contact'].map((item) => (
              <Link key={item} href={`/#${item.toLowerCase()}`} className="hover:text-primary transition-colors text-slate-900 flex items-center gap-6 ml-1">
            ...
            <Link href="/blog" className="hover:text-primary transition-colors text-slate-400 flex items-center gap-6 ml-1">
