  ...
  return (
    <section id="experience" className="min-h-screen flex flex-col justify-center border-t border-slate-100 py-24">
      <div className="max-w-5xl">
        <div className="mb-20">
          <h2 className="text-[14x] font-bold tracking-[0.5em] uppercase text-primary mb-4">
            ...
            <div key={index} className="group relative">
              ...
              <div className="grid grid-cols-1 md:grid-cols-12 gap-4">
                ...
                <div className="md:col-span-9">
                  <h4 className="text-3xl font-bold text-slate-900 mb-2 group-hover:text-primary transition-colors">
                    {exp.company}
                  </h4>
                  ...
                  <div className="flex gap-2 mt-8">
                    {exp.tags.map(tag => (
                      <span key={tag} className="px-3 py-1 text-[14px] font-bold bg-primary/10 text-primary rounded-full">
                        {tag}
                      </span>
                    ))}
                  </div>
