...
---
## Context
Docker와 CI가 해결하는 병목이 무엇인지 명확히 구분하고 싶었다.

## Content
### 소스코드는 빌드와 실행을 거쳐서 소프트웨어가 된다
...
이미지를 만들 때 필요한 것들이다: pip 버전, 로컬 캐시 상태, 개발자 머신에 전역 설치된 패키지
...
이미지가 실행될 때 필요한 것들이다: Python 버전, 시스템 라이브러리, OS 환경
