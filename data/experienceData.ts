  ...
  items: [
    {
      ...
      role: "AI Developer",
      period: "2026 - Present",
      description: "제조 도메인 Vision AI를 단독 설계·구현. AlignAI: 규칙 기반 OpenCV를 U-Net Segmentation으로 대체(탐지율 100% · PASS율 91% · CPU 추론 ~330ms), ProductConfig 레지스트리로 단일 레포 3개 제품 지원, GitHub SSOT 기반 ML CI/CD를 k3s 엣지 클러스터에 단독 구축. Edge AI LMR: Field→Cloud 4계층 · 3-Stage AI 체인으로 AUROC 99.99%. Agentic ERP 자동화로 수일 수작업을 정합성 100% 무인화. Corning Varioptic(프랑스) 계약 협상 창구 병행.",
